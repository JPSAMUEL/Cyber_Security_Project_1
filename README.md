...
Diagrams/Project Diagram.drawio.png
...
Machines within the network can only be accessed by 184.144.0.178
...
[Update the path with the name of your screenshot of docker ps output](Diagrams\docker_ps_output.png)
...
filebeat : Filebeat collects server logs, audit logs, deprectaion logs, gc logs and slow logs
matricbeat : Metricbeat collects metrics from the operating system and from services running on the server
...
https://104.40.6.5:5601/app/kibana
